            ...
            <div class="col-12 col-lg-8">
                <div class="blog-posts-area">
                    ...
                    <div class="single-blog-post featured-post single-post">
                        ...
                        <div class="post-data">
                            <a href="#" class="post-catagory" v-for="cat in article.category">{{ cat.title }}</a>
                            <a href="#" class="post-title">
                                <h6>{{ article.title }}</h6>
                            </a>
                            <div class="post-meta">
                                <!--<p class="post-author">By <a href="#">{{ article.reporter.name }}</a></p>-->
                                <p>
                                    {{article.content}}
                                </p>
                                ...
                                <div class="comment-content d-flex">
                                    ...
                                    <div class="comment-meta">
                                        ...
                                        <p>Donec turpis erat, scelerisque id euismod sit amet, fermentum vel dolor.
                                            Nulla facilisi. Sed
                                            pellen tesque lectus et accu msan aliquam. Fusce lobortis cursus quam, id
                                            mattis sapien.</p>
                                    </div>
                                </div>
                                <ol class="children">
                    ...
                    <div class="post-a-comment-area section-padding-80-0" style="margin-bottom:2rem;">
...
<script>
    ...
    export default {
        ...
        //     let res = await
        //         api.get("/article/" + params.id + "/").catch(e => {
        ...
        created() {
            let self = this;
            console.log(self)
            axios.get('article/' + self.$route.params.id)
                .then(response => {
