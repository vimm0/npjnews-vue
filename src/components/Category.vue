                            ...
                            <div class="single-blog-post featured-post mb-30" v-for="(article, index) in articles">
                                <div class="post-thumb">
                                    <router-link
                                        ...
                                        <img
                                                :src="`img/bg-img/${25+index}.jpg`" alt=""></router-link>
                                </div>
                                <div class="post-data">
                                    ...
                                    <div class="post-meta">
                                        ...
                                        <p class="post-excerp">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                            Nam eu metus sit
                                            amet
                                            odio sodales placerat. Sed varius leo ac leo fermentum, eu cursus nunc
                                            maximus. Integer
                                            convallis
                                            nisi nibh, et ornare neque ullamcorper ac. Nam id congue lectus, a venenatis
                                            massa. Maecenas
                                            justo
